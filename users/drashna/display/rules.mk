...
ifeq ($(strip $(CUSTOM_QUANTUM_PAINTER_ENABLE)), yes)
    ifeq ($(strip $(QUANTUM_PAINTER_ENABLE)), yes)
        ...
        OPT_DEFS += -DCUSTOM_QUANTUM_PAINTER_ENABLE -DQUANTUM_PAINTER_NUM_IMAGES=64 -DQUANTUM_PAINTER_SUPPORTS_256_PALETTE=TRUE \
                    -DQUANTUM_PAINTER_SUPPORTS_NATIVE_COLORS=TRUE -DQUANTUM_PAINTER_PIXDATA_BUFFER_SIZE=4096
        CONFIG_H += $(USER_PATH)/display/painter/config.h

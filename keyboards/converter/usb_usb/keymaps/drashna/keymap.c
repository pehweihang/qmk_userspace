...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    [4] = LAYOUT_wrapper(
        ...
        _______, QK_RBT, AUTO_CTN, _______, _______,          _______,          _______, _______, _______, KC_NUKE, _______, _______, _______,  _______, _______, _______,    _______,          _______, _______,    _______, _______
    ),
};

...
#define LAYOUT_5x6_full_right_base( \
  ...
  LAYOUT_5x6_full_right_wrapper( \
     ...
     KC_GRV, DISPLAY_MENU, OS_LALT, OS_LGUI,                                            KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, \
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_MOUSE] = LAYOUT_5x6_full_right(
        _______, _______, _______, _______, _______, _______,                        _______, DPI_RMOD,DPI_MOD, S_D_RMOD,S_D_MOD, PD_JIGG,
        _______, _______, _______, _______, _______, _______,                        KC_WH_U, _______, _______, _______, _______, KC_ACCEL,
